...
function useHiddenRef(styles) {
  /*
    DESCRIPTION:
      ...
      Returns a selfRef object that, when used by a component, will add a styles.hidden class
      which is removed from the component when it is scrolled 90% of the way from below into
      the viewport.
